...
import { ArrowLeft, Home, Video, FileText, CheckCircle, Clock, Play, ChevronLeft, ChevronRight, Maximize2 } from 'lucide-react';
                  ...
                  <div className="playlist-item-info">
                    ...
                    <div className="playlist-item-meta">
                      {listItem.type === 'video' && listItem.duration && (
                        <span><Clock size={12} /> {formatDuration(listItem.duration)}</span>
                      )}
